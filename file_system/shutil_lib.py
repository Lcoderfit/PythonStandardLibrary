...
Created: 
C:\Users\VIRUSE~1.V-D\AppData\Local\Temp\tmpgts0i3ay\here
C:\Users\VIRUSE~1.V-D\AppData\Local\Temp\tmpgts0i3ay\here\a.txt
C:\Users\VIRUSE~1.V-D\AppData\Local\Temp\tmpgts0i3ay\here\inhere
C:\Users\VIRUSE~1.V-D\AppData\Local\Temp\tmpgts0i3ay\here\tarfile_lib.py
C:\Users\VIRUSE~1.V-D\AppData\Local\Temp\tmpgts0i3ay\here\__init__.py
C:\Users\VIRUSE~1.V-D\AppData\Local\Temp\tmpgts0i3ay\here\inhere\inhe.py
    """
...
def shutil_disk_usage():
    ...
    # 一般商家对存储产品：1GB = 1000MB (B表示byte，即字节)
    # 计算机对存储产品的计算： 1GB = 1024MB
    # 例如：商家说的80G内存，其实计算机计算出来的实际内存为74.5G
    # 80*10^9/1024/1024/1024
    gib = 2 ** 30   # gibibyte，计算机使用
    gb = 10 ** 9      # gigabyte, 商家用的
    ...
    """
shutil_disk_usage: 
total:  64.42GB    60.00GiB
use_b:  15.70GB    14.62GiB
free_b:  48.72GB    45.37GiB
    """
